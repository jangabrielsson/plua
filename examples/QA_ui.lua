...
function QuickApp:testBtn3(ev)
  print("testBtn3")
  -- Open web interface in a specific browser
  local browsers = _PY.list_browsers()
  if browsers and #browsers > 0 then
    print("Opening web interface in:", browsers[1])
    _PY.open_browser_specific("http://localhost:8888/static/plua2_main_page.html", browsers[1])
  else
    print("No browsers available, using default")
