...
This directory contains clean, end-user examples that demonstrate the capabilities of plua2. These examples are designed to be educational and show best practices for using the plua2 runtime.
...
```bash
plua2 examples/http_client_example.lua
```
...
```bash
plua2 examples/tcp_socket_example.lua
```
...
```bash
plua2 examples/udp_socket_example.lua
```
...
```bash
plua2 examples/http_server_example.lua
```
...
```bash
plua2 examples/json_example.lua
```
...
```bash
plua2 examples/timer_async_example.lua
```
...
```bash
plua2 examples/auto_terminating_example.lua
```
...
```bash
plua2 examples/http_server_auto_termination_example.lua
...
```bash
plua2 examples/builtin_modules_test.lua
```
...
- All code follows Lua best practices and plua2 conventions
