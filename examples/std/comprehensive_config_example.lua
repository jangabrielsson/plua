...
local app_config = {
    ...
    user_agent = _PY.getenv_dotenv("USER_AGENT", "plua/" .. _PY.config.plua_version),
}
...
local config_dir = app_config.home_dir .. app_config.file_sep .. ".plua"
local log_file = config_dir .. app_config.file_sep .. "app.log"
local temp_dir = _PY.config.tempdir .. app_config.file_sep .. "plua_temp"
...
if app_config.platform == "windows" then
    path_example = "C:\\Users\\" .. _PY.config.username .. "\\Documents\\plua"
    print("   Windows path example:", path_example)
elseif app_config.platform == "darwin" then
    path_example = "/Users/" .. _PY.config.username .. "/Documents/plua"
    print("   macOS path example:", path_example)
else
    path_example = "/home/" .. _PY.config.username .. "/plua"
