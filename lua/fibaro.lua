...
function api.post(path, data) return hc3_sync("POST", path, data) end
function api.put(path, data) return hc3_sync("PUT", path, data) end
function api.delete(path) return hc3_sync("DELETE", path) end
