...
This module is regenerated by `src/plua/generate_typed_fibaro_api.py` from
the vendored Fibaro Swagger/OpenAPI specifications. Manual edits will be
lost the next time the generator runs. To change endpoint behaviour, edit
the generator or the Lua-side handler invoked via `fibaroApiHook()`.
"""
