...
Usage:
    ...
    # Get help
    python src/plua2/generate_typed_fibaro_api.py --help
...
Important: Keep this file in src/plua2/ - it's critical for maintaining the API!
"""
...
def main():
    ...
    project_root = script_dir.parent.parent  # src/plua2 -> src -> project_root
